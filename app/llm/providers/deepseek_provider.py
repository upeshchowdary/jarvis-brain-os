...
class DeepSeekProvider(AbstractHTTPLLMProvider):
    """Adapter for DeepSeek AI Chat Completions API."""

    def __init__(self, api_key: str, model_name: str = "deepseek-chat", timeout: float = 60.0, **kwargs: Any) -> None:
    ...
    async def generate_completion(
        ...
        **kwargs: Any,
        ...
        if not self.api_key:
            raise LLMAuthenticationError("DEEPSEEK_API_KEY is not configured.")
