...
class OpenRouterProvider(AbstractHTTPLLMProvider):
    """Adapter for OpenRouter API."""

    def __init__(self, api_key: str, model_name: str = "openai/gpt-4o", timeout: float = 60.0, **kwargs: Any) -> None:
    ...
    async def generate_completion(
        ...
        **kwargs: Any,
        ...
        headers = {
            ...
            "X-Title": "JARVIS AI Brain Engine",
