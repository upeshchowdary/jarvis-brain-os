...
class GroqProvider(AbstractHTTPLLMProvider):
    """Adapter for Groq Cloud Chat Completions API."""

    def __init__(self, api_key: str, model_name: str = "llama-3.1-70b-versatile", timeout: float = 60.0, **kwargs: Any) -> None:
